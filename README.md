...
| `requestWithdrawal` | currency, amount, address (_receipient's_)                                       | Create a new withdrawal request. **Must confirm via email within 5 minutes to complete withdrawal** |
