...
| `getDeposit`        |  currency (_optional_), limit (_default = 50_), page (_default = 1_)                                                                                | User's list of all deposits                                                                                                                                            |
| `getWithdrawal`     |  currency (_optional_), limit (_default = 50_), page (_default = 1_)                                                                                 | User's list of all withdrawals                                                                                                                                         |
...
| `getUserTrade`      |  symbol (_optional_), limit (_default = 50_), page (_default = 1_)                                                                                | User's list of all trades                                                                                                                                              |
