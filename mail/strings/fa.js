...
const SIGNUP = {
	...
	BODY: {
		1: () => `با تشکر از ثبت نام در ${API_NAME()}.
		بخش فروش ما پیام شما را دریافت نموده و در حال رسیدگی به آن می باشد و در کمترین زمان ممکن به آن پاسخ خواهد داد.
		در صورت وجود هر سوال و یا ابهام با ما تماس بگیرید <a href="mailto:${SUPPORT_EMAIL()}">${SUPPORT_EMAIL()}</a>`,
		2: 'برای شروع روند ثبت نام خود ، دکمه زیر را فشار دهید.',
		3: 'حساب کاربری من را فعال کن'
	},
