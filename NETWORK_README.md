...
| `updatePendingMint` | **transactionId**, **status** (_optional_), **dismissed** (_optional_), **rejected** (_optional_), **updatedTransactionId** (_optional_), **email** (_optional_, _default_=`true`), **updatedDescription** (_optional_) | Update a pending mint |
...
| `updatePendingBurn` | **transactionId**, **status** (_optional_), **dismissed** (_optional_), **rejected** (_optional_), **updatedTransactionId** (_optional_), **email** (_optional_, _default_=`true`), **updatedDescription** (_optional_) | Update a pending burn |
