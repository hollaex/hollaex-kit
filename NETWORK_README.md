...
| `checkTransaction` | <ul><li>**userId**: User HollaEx Network ID</li><li>**transactionId**: TXID of transaction to check</li><li>**address**: Address of transaction</li><li>**network**: Blockchain network to create address for e.g. `trx`</li><li>**opts**: Object with additional params</li><li>**opts.isTestnet**: (_optional_, _default_=`false`) Set to `true` to check testnet blockchain</li></ul> | Check transaction in network. Will update transaction status on Kit accordingly |
