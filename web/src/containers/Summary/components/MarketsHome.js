...
import './MarketsHome.css';
import MarketListHome from '../../TradeTabs/components/MarketListHome';
...
class MarketsHome extends Component {
	...
	render() {
		...
		return (
			<div className="d-flex justify-content-center align-items-center flex-column features-container bg-light-gray">
...
const MarketWrapper = withConfig(MarketsHome);
