...
export const getTheme = ({
  ...
  "paneProperties.vertGridProperties.color": rest['calculated_trad-view_axis'] || TRADING_VIEW_AXIS,
  "paneProperties.horzGridProperties.color": rest['calculated_trad-view_axis'] || TRADING_VIEW_AXIS,
  // "paneProperties.crossHairProperties.color": "#1f212a",
  "symbolWatermarkProperties.transparency": 90,
  "symbolWatermarkProperties.color": rest['calculated_trad-view_watermark'] || TRADING_VIEW_WATERMARK,
  "scalesProperties.textColor": rest['calculated_trad-view_text'] || TRADING_VIEW_TEXT,
  "scalesProperties.backgroundColor": rest['base_background'] || BACKGROUND_COLOR,
  // Candles-property
...
export const getVolume = ({ 'trading_buying-related-elements': buy = UP_COLOR_WHITE, 'trading_selling-related-elements': sell = DOWN_COLOR_WHITE }) => ({
