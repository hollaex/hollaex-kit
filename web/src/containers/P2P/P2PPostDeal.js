	...
	return (
		<div className={isMobile ? 'h-100' : ''}>
			...
			>
				...
				{!isMobile ? (
					<div className="p2p-post-deal-details-container">
					...
					<P2PPostDealMobile
						...
						setSpread={setSpread}
						setDynamicPair={setDynamicPair}
						getDynamicRate={getDynamicRate}
						priceType={priceType}
						...
						setSpendingAsset={setSpendingAsset}
						setDynamicRate={setDynamicRate}
						setStep={setStep}
						...
						setAddMethodDetails={setAddMethodDetails}
						terms={terms}
						setTerms={setTerms}
