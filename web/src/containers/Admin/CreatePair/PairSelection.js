...
const PairSelection = ({
    ...
    return (
        <Fragment>
            <div className="first-title">{activeTab === '0' ? 'HollaEx pairs' : 'Other pairs'}</div>
            <div className="title">Select a trading pair</div>
            <div>Trading pair are based on assets selected in the previous step. To see more trading pairs go back and add more assets.</div>
            ...
            <div className="footer">
                ...
                <div className="anchor" onClick={handleBack}>Create a new pair</div>
            </div>
        </Fragment>
    );
}
