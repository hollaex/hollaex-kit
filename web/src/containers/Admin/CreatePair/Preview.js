...
const Preview = ({
    ...
    const pair_base_data = allCoins.filter((data) => data.symbol === formData.pair_base)[0] || {};
    const pair2_data = allCoins.filter((data) => data.symbol === formData.pair_2)[0] || {};
    return (
        <div>
                    ...
                    <Fragment>
                        ...
                        <div className="grey-warning">
                            ...
                            <div>
                                ...
                                <div className="description">To avoid delays it is important to take the time to review the accuracy of the details below</div>
                            </div>
                        </div>
                    </Fragment>
                )
            ...
            >
                ...
                >
                    <div>
                        ...
                        {isPreview || isConfigure
                            ?
                            <div>
                                (<Link to={`/admin/financials?tab=1&preview=true&symbol=${formData.pair_base}`}>
                                    View details
                                    </Link>)
                                </div>
                            : null
                    ...
                    <div>
                        ...
                        {isConfigure || isPreview
                            ?
                            <div>
                                (<Link to={`/admin/financials?tab=1&preview=true&symbol=${formData.pair_2}`}>
                                    View details
                                    </Link>)
                                </div>
                            : null
                ...
                <div className={!isPreview && !isConfigure ? "right-container" : ""}>
                    ...
                    <div className="right-content">
                        ...
                        {isConfigure
                            ? <div><Button type="primary" onClick={onEdit}>Edit</Button></div>
                            : null
                        }
                    </div>
                    {isPreview || isConfigure
                        ? <div className="right-content">
                            ...
                            <div className="d-flex">
                                <div className="btn-wrapper">
                                    <Button type="danger" onClick={() => onDelete(formData)}>Remove</Button>
                                    <div className="separator"></div>
                                    <div className="description-small remove">Removing this pair will permanently delete this pair from your exchange. Use with caution!</div>
                                </div>
                            </div>
                        </div>
                        : null
            ...
            {!isPreview && !isConfigure
                ? (
                    <div className="btn-wrapper">
                        ...
                        <div className="separator"></div>
                        <Button className="green-btn" type="primary" onClick={() => handleNext(formData)}>
                            Next
                        </Button>
                    </div>
                )
