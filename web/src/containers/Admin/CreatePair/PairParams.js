    ...
    render() {
        ...
        return (
            <div>
                ...
                <div>Values have been preset based on the rough dollar value of the base asset.</div>
                ...
                <div className="field-wrap">
                    ...
                    <div className="description">
                        <div>Minimum - quoted trading price that can be traded for this pair.</div>
                    </div>
                    <div className="full-width">
                        {formData.min_price}
                    </div>
                ...
                <div className="field-wrap last">
                    ...
                    <div className="description">
                        <div>Maximum - quoted trading price that can be traded for this pair.</div>
                    </div>
                    <div className="full-width">
                        {formData.max_price}
                    </div>
                ...
                <div className="field-wrap">
                    ...
                    <div className="description">
                        <div>The increment - amount allowed to be adjusted up and down in the order entry panel</div>
                    </div>
                    <div className="full-width">
                        {formData.increment_size}
                    </div>
                </div>
                <div className="field-wrap last">
                    <div className="sub-title">Increment Price</div>
                    <div className="description">
                        <div>The increment - price allowed to be adjusted up and down in the order entry panel</div>
                    </div>
                    <div className="full-width">
                        {formData.increment_price}
                    </div>
                </div>
                <div className="edit-wrapper">
                </div>
