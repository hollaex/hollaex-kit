        ...
        <Fragment>
            ...
            <div className="assets-wrapper">
                ...
                <div className="field-wrap">
                    ...
                    >
                        ...
                        <div className="description">
                            ...
                            <div>Amount is dependents on user level and what you set later on.</div>
                        </div>
                    </Checkbox>
                </div>
                <div className="field-wrap">
                    ...
                    >
                        ...
                        <div className="description">
                            <div>Allow withdrawal for this coin once the exchange launches.</div>
                            <div>Amount is dependents on user level and what you set later on.</div>
                        </div>
                    </Checkbox>
                </div>
                <div className="field-wrap">
                    ...
                    <div className="description">
                        <div>Enter the fee amount for when this coin is withdraw from your exchange</div>
                    </div>
                    <InputNumber
                        name="withdrawal_fee"
                ...
                <div className="field-wrap">
                    ...
                    <div className="description">
                        <div>Sell the minimum amount allowed to be withdrawn for this coins</div>
                    </div>
                    <InputNumber
                        name="min"
                ...
                <div className="field-wrap">
                    ...
                    <div className="description">
                        <div>Sell the maximum amount allowed to be withdrawn for this coins</div>
                    </div>
                    <InputNumber
                        name="max"
                ...
                <div className={editParams ? "field-wrap" : "field-wrap last"}>
                    ...
                    <div className="description">
                        <div>Sell the increment amount that can be adjusted up and down for this coins</div>
                    </div>
                    <InputNumber
                        name="increment_unit"
