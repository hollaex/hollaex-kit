...
const AssetConfig = (props) => {
    ...
    const isBlockchainSearch = coinFormData.type === 'blockchain'
    ...
    const renderFields = () => {
        ...
        if (coinFormData.type === 'blockchain' && (coinFormData.network === 'eth' || coinFormData.network === 'bnb')) {
            return (
        ...
        } else if (coinFormData.type === 'blockchain' && coinFormData.network !== 'eth') {
            return (
                <div className="md-field-wrap-search">
                    ...
                    <div className="sub-title">Contract(<a href={CONTACT_DESCRIPTION_LINK}><span className="link">what's this?</span></a>)</div>
                    <Form.Item
                        name="contract"
                        rules={[
                            {
            ...
            <Form form={form} name="AssetConfigForm" onFinish={handleSubmit} >
                <div className="section-wrapper">
                    ...
                    <div className="color-wrapper">
                        ...
                        <div>
                                ...
                                {isBlockchainSearch
                                    ? (
                                        <Fragment>
                                            ...
                                            <span className="field-description">{coinFormData.symbol}</span>
                                        </Fragment>
                                    ) : (
                                        <Fragment>
                                            <div>
                                            ...
                                            <span className="field-description">Enter the shorthand symbol for this asset (example 'BTC')</span>
                                            <Form.Item
                                                name="symbol"
                                                rules={[
                                                    {
                                                    ...
                                                    {
                                                        validator: (!isConfigureEdit && !isEdit)
                                                            ? checkCoin
                                                            : null
                                                    }
                                                ]}
                            ...
                            <div>
                                <span className="sub-title">Color</span>{' '}<span>(for exchange purposes):</span>
                            </div>
                            <ColorPicker
                                value={
                                    coinFormData.meta
                ...
                <div className="section-wrapper">
                    ...
                    <div className="d-flex align-items-center">
                        <div className="md-field-wrap">
                            {coinFormData.logo
                                ? <img src={coinFormData.logo || ''} alt="coin" className="preview-icon" />
                                : <div className="icon-upload">
                                    <div className="file-container">
                                        <label>
                                            <UploadOutlined style={{ fontSize: '94px', color: '#808080', marginRight: '8px' }} />
                                            <input
                                                type="file"
                        ...
                        <div className="md-field-wrap">
                            <div>
                                ...
                                <span>(this icon will be used in various places on your exchange):</span>
                            </div>
                            <div className="file-container">
                                <label>
                    ...
                    <div className="d-flex align-items-center">
                        ...
                        <div className="md-field-wrap">
                            {isBlockchainSearch
                                ...
                                : <Fragment>
                                    <div>
                                        <span className="sub-title">Decimal points</span>{' '}<span>(max 18):</span>
                                    </div>
                                    <InputNumber
                                        name="decimal_points"
                                        min={0}
                ...
                <div className="section-wrapper last">
                    ...
                    <div className="md-field-wrap">
                        <div>Make this asset public so that others can see and add this asset to their platform.</div>
                        <Checkbox
                            name="is_public"
