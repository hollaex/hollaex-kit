...
class GeneralContent extends Component {
    ...
    handleBackConfirm = () => {
        ...
        if (screen === 'step2') {
            this.setState({ screen: '', selectedCountry: { ...this.state.selectedCountry, isFocus: true } })
    ...
    removeCountry = (value) => {
        ...
        const names = _get(constants, 'kit.black_list_countries', []).filter(data => data !== value.value)
        this.setState({
            screen: 'step3',
            isVisible: true,
    ...
    handleConfirm = () => {
        const { screen, constants, selectedCountry, removeCountryValue } = this.state
        if (screen === 'step2') {
            if (_get(constants, 'kit.black_list_countries', []).includes(selectedCountry.value)) {
                message.warn("Country is already exist in blacklist")
            } else {
                this.handleSubmitName({
                    black_list_countries: [...constants.kit.black_list_countries, selectedCountry.value]
                })
            }
            this.setState({ isVisible: false, selectedCountry: { isFocus: false } })
        } else if (screen === 'step3') {
                ...
                return (
                    <div className="general-geo-wrapper">
                        ...
                        <div className="pt-3 pb-3">
                            ...
                            you do want to restrict access from this location to your platform.
                        </div>
                    ...
                    {activeTab === 'branding'
                        ...
                        <div>
                            ...
                            <div className="mb-5">
                                ...
                                <div className="description">
                                    <span>To change the login/signup background image please visit the </span><Link to="/admin/general?tab=4">onboarding page</Link>.
                                </div>
                            </div>
                        </div>
                        : null
                ...
                {activeTab === 'security'
                    ...
                    <div>
                        <div className="general-wrapper">
                            ...
                            <div className="description">
                                Add a blacklist to block activity from certain location.
                            </div>
