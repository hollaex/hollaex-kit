						...
						{userData.activated ? (
							...
							<Fragment>
								<div>
									...
									<div className="info-link" onClick={() => { recoverUser(); }}>
										Recover
									</div>
								</div>
								<div>
									<svg style={{ position:'relative', top: 2, marginLeft: 15, transform: 'rotate(40deg)'}} fill="#fff" height="40px" width="40px" viewBox="0 0 512.001 512.001">
										<g>
