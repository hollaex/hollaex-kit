...
const LoginTable = () => {
	...
	const columns = [
		...
		},
		{
			...
			key: 'timestamp',
			render: (user_id, data) => {
				return <div className="d-flex">{formatDate(data?.timestamp)}</div>;
			},
		},
		{
			title: 'Result',
		...
		},
		{
			...
			key: 'ip',
			render: (user_id, data) => {
				return <div className="d-flex">{data?.ip}</div>;
			},
		},
		{
			title: 'Domain',
			...
			key: 'domain',
			render: (user_id, data) => {
				return <div className="d-flex">{data?.domain}</div>;
			},
		},
		{
			title: 'Device',
			...
			key: 'device',
			render: (user_id, data) => {
				return <div className="d-flex">{data?.device}</div>;
			},
		},
	];
