...
export const ICONS = {
	LOGO_GREY: `${process.env.REACT_APP_PUBLIC_URL}/assets/hollaEx_logo-grey.svg`,
	LOGO_BLACK: `${process.env.REACT_APP_PUBLIC_URL}/assets/hollaEx_logo-blk.svg`,
	TRADE_HISTORY_DARK: `${
	...
	BTC_ICON_DARK: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/btc-icon-dark-01.svg`,
	BTC_ICON: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/btc-icon-01.svg`,
	ETH_ICON: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/eth-icon-01.svg`,
	ETH_ICON_DARK: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/eth-icon-dark-01.svg`,
	EUR_ICON: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/eur-icon.svg`,
	LIFESAVER: `${process.env.REACT_APP_PUBLIC_URL}/assets/acounts/account-icons-05.svg`,
	CONTACT_US_ICON: `${
		process.env.REACT_APP_PUBLIC_URL
	...
	LAPTOP: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/compute-play-black.svg`,
	LAPTOP_COLOR: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/icons/compute-play-color.svg`,
	TELEGRAM: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/telegram-black.svg`,
	TELEGRAM_COLOR: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/telegram-color.svg`,
	BCH_ICON: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/bch-icon.svg`,
	BCH_ICON_DARK: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/bch-icon.svg`,
	BCH_NAV_ICON: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/bch-icon-nav.svg`,
	XRP_ICON: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/xrp-icon-01.svg`,
	XRP_ICON_DARK: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/xrp-icon-01.svg`,
	XRP_NAV_ICON: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/xrp-icon-01.svg`,
	CHECK: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/Orderbook scrolling-01.svg`,
	DARK_CHECK: `${
		process.env.REACT_APP_PUBLIC_URL
	...
	RED_WARNING: `${process.env.REACT_APP_PUBLIC_URL}/assets/acounts/account-icons-09.svg`,
	GENDER_F: `${process.env.REACT_APP_PUBLIC_URL}/assets/acounts/account-icons-10.svg`,
	GENDER_M: `${process.env.REACT_APP_PUBLIC_URL}/assets/acounts/account-icons-11.svg`,
	GENDER_FEMALE: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/acounts/account-icons-26.svg`,
	GENDER_MALE: `${process.env.REACT_APP_PUBLIC_URL}/assets/acounts/account-icons-27.svg`,
	BITCOIN_CLEAR: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/acounts/account-icons-13.svg`,
	RED_ARROW: `${process.env.REACT_APP_PUBLIC_URL}/assets/acounts/account-icons-16.svg`,
	BLUE_CLIP: `${process.env.REACT_APP_PUBLIC_URL}/assets/acounts/account-icons-17.svg`,
	BLACK_CHECK: `${process.env.REACT_APP_PUBLIC_URL}/assets/acounts/account-icons-19.svg`,
	KEYS: `${process.env.REACT_APP_PUBLIC_URL}/assets/acounts/account-icons-22.svg`,
	OTP_KEYS: `${process.env.REACT_APP_PUBLIC_URL}/assets/acounts/account-icons-29.svg`,
	GREEN_CHECK: `${process.env.REACT_APP_PUBLIC_URL}/assets/acounts/account-icons-23.svg`,
	LETTER: `${process.env.REACT_APP_PUBLIC_URL}/assets/acounts/account-icons-24.svg`,
	SQUARE_DOTS: `${process.env.REACT_APP_PUBLIC_URL}/assets/acounts/account-icons-25.svg`,
	OTP_CODE: `${process.env.REACT_APP_PUBLIC_URL}/assets/acounts/account-icons-28.svg`,
	COPY_NEW: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/copy.svg`,
	COPY_NOTIFICATION: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/images/copy-icon-snack-notification.svg`,
	ACCOUNT_LINE: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/account.svg`,
	ACCOUNT_RECOVERY: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/images/account-recovery.svg`,
	BITCOIN_WALLET: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/bitcoin-wallet.svg`,
	CHECK_SENDING_BITCOIN: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/images/check-sending-bitcoin.svg`,
	DATA: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/data.svg`,
	DEPOSIT_BITCOIN: `${
		process.env.REACT_APP_PUBLIC_URL
	...
	DEPOSIT_SUCCESS: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/D-W-Success.svg`,
	WITHDRAWAL_SUCCESS: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/images/D-W-Success.svg`,
	EMAIL: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/email.svg`,
	EMAIL_SENT: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/email-sent.svg`,
	OTP_DOTS: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/f2fa-pin.svg`,
	DEPOSIT_BASE: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/fiat-deposit.svg`,
	DEPOSIT_BASE_COIN_COMPLETE: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/images/fiat-deposit-completed.svg`,
	BASE_WALLET: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/fiat-wallet.svg`,
	GEAR_BLACK: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/gear.svg`,
	GEAR_GREY: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/gear-grey.svg`,
	HELP_ICON: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/help.svg`,
	ID_BLACK: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/id.svg`,
	ID_GREY: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/id-grey.svg`,
	INCOMING_BITCOIN: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/images/Incoming-bitcoin.svg`,
	INCOMING_BTC: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/incoming-btc.svg`,
	INCOMING_TOMAN: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/incoming-toman.svg`,
	LICENSE: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/licence.svg`,
	LIQUID: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/liquid.svg`,
	MARGIN: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/margin.svg`,
	PASSWORD_RESET: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/password-reset.svg`,
	PAYMENT_OPTIONS: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/images/payment-options.svg`,
	QUICK_TRADE: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/quick-trade.svg`,
	QUICK_TRADE_TAB: `${
		process.env.REACT_APP_PUBLIC_URL
	...
	SECURE: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/secure.svg`,
	SECURITY_BLACK: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/security.svg`,
	SECURITY_GREY: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/security-grey.svg`,
	SET_NEW_PASSWORD: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/images/set-new-password.svg`,
	SUCCESS_BLACK: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/success-black.svg`,
	TRADE_HISTORY: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/trade-history.svg`,
	TRADE_HISTORY_GREY: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/images/trade-history-grey.svg`,
	TRADES_ICON: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/trade-history.svg`,
	TRADE_SUCCESS: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/trade-success.svg`,
	TRANSACTION_HISTORY: `${
		process.env.REACT_APP_PUBLIC_URL
	...
	WITHDRAW: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/withdraw.svg`,
	WITHDRAW_HISTORY: `${
		process.env.REACT_APP_PUBLIC_URL
	...
	BLUE_EDIT: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/blue-edit-exir-icon.svg`,
	BLUE_PLUS: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/max-plus-blue-icon.svg`,
	BLUE_TIMER: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/timer-icon.svg`,
	DROPDOWN_ARROW: `${
		process.env.REACT_APP_PUBLIC_URL
	...
	VERIFICATION_WARNING: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/astrics.svg`,
	VERIFICATION_SUCCESS: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/images/success-check-box.svg`,
	VERIFICATION_DOC: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/doc.svg`,
	VERIFICATION_DOC_INACTIVE: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/images/doc-inactive.svg`,
	VERIFICATION_EMAIL: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/email_2.svg`,
	VERIFICATION_EMAIL_INACTIVE: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/images/email-inactive.svg`,
	VERIFICATION_MOBILE: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/mobile.svg`,
	VERIFICATION_MOBILE_INACTIVE: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/images/mobile-inactive.svg`,
	VERIFICATION_BANK: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/bank.svg`,
	VERIFICATION_BANK_INACTIVE: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/images/bank-inactive.svg`,
	VERIFICATION_ID: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/id_2.svg`,
	...
	ARROW_DOWN: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/arrow-down.svg`,
	TOKENS_INACTIVE: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/dev-icon.svg`,
	TOKENS_ACTIVE: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/dev-icon.svg`,
	TOKEN_REVOKED: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/api-key-revoked.svg`,
	TOKEN_ACTIVE: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/api-key-active.svg`,
	TOKEN_TRASHED: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/api-key-trashed.svg`,
	TOKEN_GENERATE: `${
		process.env.REACT_APP_PUBLIC_URL
	...
	TOKEN_CREATED: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/api-key-created.svg`,
	TOKEN_CREATED_DARK: `${
		process.env.REACT_APP_PUBLIC_URL
	...
	ITEM_OPTIONS: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/item-options.svg`,
	DOTTED_GRIP: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/images/dotted-grip-chat-repeat-pattern.svg`,
	CHAT: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/chat-icon.svg`,
	WITHDRAW_MAIL_CONFIRMATION: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/images/withdraw-mail-confirmation.svg`,
	CLOSE_CROSS: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/close-cross-tab.svg`,
	TAB_PLUS: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/tab-plus.svg`,
	TAB_MINUS: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/tab-minus.svg`,
	TAB_SUMMARY: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/tab-summary.svg`,
	TAB_WALLET: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/tab-wallet.svg`,
	TAB_SECURITY: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/tab-security.svg`,
	TAB_VERIFY: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/tab-verify.svg`,
	TAB_SETTING: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/tab-setting.svg`,
	TAB_API: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/tab-api.svg`,
	...
	TAB_SIGNOUT: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/signout.svg`,
	DOUBLE_ARROW: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/double-arrow.svg`,
	SEARCH: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/search.svg`,
	...
	PENDING_TIMER: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/pending-timer.svg`,
	VOLUME_PENDING: `${
		process.env.REACT_APP_PUBLIC_URL
	...
	NOTE_KYC: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/note-KYC.svg`,
	SIDEBAR_CHAT: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/bottom-chat-icon.svg`,
	SIDEBAR_HELP: `${
		process.env.REACT_APP_PUBLIC_URL
	...
	REFER_ICON: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/refer-icon.svg`,
	EDIT_ICON: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/edit-icon.svg`
};

export const SOCIAL_ICONS = {
	FACEBOOK: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/social-grey-icons.svg`,
	TWIITER: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/social-grey-icons02.svg`,
	INSTAGRAM: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/social-grey-icons03.svg`,
	TELEGRAM: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/social-grey-icons04.svg`,
	GOOGLE: `${process.env.REACT_APP_PUBLIC_URL}/assets/icons/google.png`
};
...
export const FEATURES_ICONS = {
	...
	SECURITY: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/features-lock-icons.svg`,
	REPORTING: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/features-data-icons.svg`,
	SUPPORT: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/images/features-support-icons.svg`,
	LEGAL: `${process.env.REACT_APP_PUBLIC_URL}/assets/images/features-legal-icons.svg`
};

export const SUMMMARY_ICON = {
	KRAKEN: `${process.env.REACT_APP_PUBLIC_URL}/assets/summary/kraken.png`,
	SNAPPER: `${process.env.REACT_APP_PUBLIC_URL}/assets/summary/snapper.png`,
	SHRIMP: `${process.env.REACT_APP_PUBLIC_URL}/assets/summary/shrimp.png`,
	LEVIATHAN: `${process.env.REACT_APP_PUBLIC_URL}/assets/summary/leviathan.png`,
	LEVIATHAN_DARK: `${process.env.REACT_APP_PUBLIC_URL}/assets/summary/leviathan_dark.png`
};
...
export const AUDIOS = {
	...
	ORDER_COMPLETED: `${process.env.REACT_APP_PUBLIC_URL}/assets/audio/order-filled.wav`,
	ORDER_PARTIALLY_COMPLETED: `${
		process.env.REACT_APP_PUBLIC_URL
	}/assets/audio/part-fill.wav`,
	CANCEL_ORDER: `${process.env.REACT_APP_PUBLIC_URL}/assets/audio/cancel_order.wav`,
