		...
		ID_DOCUMENTS_FORM: {
			...
			INFORMATION: {
				...
				ID_SECTION: {
					...
					LIST_ITEM_0: '{0}MB', //new
					LIST_ITEM_1:
						'HIGH QUALITY (color images, 300dpi resolution or higher and Image must be 2MB in size per image or lower) Use a Webtool to resize.', // remove
