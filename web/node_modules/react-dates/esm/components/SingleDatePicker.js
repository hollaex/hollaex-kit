...
var propTypes = process.env.NODE_ENV !== "production" ? forbidExtraProps(_objectSpread2({}, withStylesPropTypes, {}, SingleDatePickerShape)) : {};
var defaultProps = {
...
function (_ref) {
  ...
  _proto.responsivizePickerPosition = function responsivizePickerPosition() {
    ...
    if (!withPortal && !withFullScreenPortal) {
      ...
      this.setState({
        dayPickerContainerStyles: _objectSpread2({}, getResponsiveContainerStyles(anchorDirection, currentOffset, containerEdge, horizontalMargin), {}, appendToBody && getDetachedContainerStyles(openDirection, anchorDirection, this.container))
      });
    }
  };
