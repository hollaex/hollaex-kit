...
var propTypes = process.env.NODE_ENV !== "production" ? forbidExtraProps(_objectSpread2({}, withStylesPropTypes, {
...
function (_ref) {
  ...
  _proto.render = function render() {
    ...
    }, _objectSpread2({}, getTransformStyles(transformValue), {
      width: width
    })), {
...
export default withStyles(function (_ref2) {
  ...
  return {
    ...
    CalendarMonthGrid__vertical_scrollable: _objectSpread2({
      margin: '0 auto',
      overflowY: 'scroll'
