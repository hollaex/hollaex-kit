...
function (_ref) {
  ...
  function DayPickerRangeController(props) {
    ...
    _this.state = {
      ...
      phrases: _objectSpread2({}, props.phrases, {
  ...
  _proto.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    if (Object.keys(modifiers).length > 0) {
      this.setState({
        visibleDays: _objectSpread2({}, visibleDays, {}, modifiers)
      });
    }
    ...
    if (didFocusChange || phrases !== prevPhrases) {
      ...
      this.setState({
        phrases: _objectSpread2({}, phrases, {
          chooseAvailableDate: chooseAvailableDate
        })
      });
    }
  ...
  _proto.onPrevMonthClick = function onPrevMonthClick() {
    ...
    this.setState({
      ...
      visibleDays: _objectSpread2({}, newVisibleDays, {}, this.getModifiers(prevMonthVisibleDays))
    }, function () {
  ...
  _proto.onNextMonthClick = function onNextMonthClick() {
    ...
    this.setState({
      ...
      disablePrev: this.shouldDisableMonthNavigation(minDate, newCurrentMonth),
      disableNext: this.shouldDisableMonthNavigation(maxDate, newCurrentMonth),
      visibleDays: _objectSpread2({}, newVisibleDays, {}, this.getModifiers(nextMonthVisibleDays))
    }, function () {
  ...
  _proto.onMultiplyScrollableMonths = function onMultiplyScrollableMonths() {
    ...
    this.setState({
      visibleDays: _objectSpread2({}, visibleDays, {}, this.getModifiers(newVisibleDays))
    });
  };
