...
function renderNumberList(position) {
  ...
  for (var i = 0; i < 30; i++) {
    ...
    childrenToReturn.push(_react["default"].createElement("p", {
      key: i.toString(),
...
function (_Component) {
  ...
  function ScrollNumber(props) {
    ...
    _this.renderScrollNumber = function (_ref) {
      ...
      if (displayComponent) {
        return _react["default"].cloneElement(displayComponent, {
      ...
      return (0, _react.createElement)(component, newProps, _this.renderNumberElement(prefixCls));
    };
  ...
  _createClass(ScrollNumber, [{
    ...
    value: function render() {
      return _react["default"].createElement(_configProvider.ConfigConsumer, null, this.renderScrollNumber);
    }
  }], [{
