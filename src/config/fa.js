export default {
  ...
  HOME: {
    ...
    SECTION_3_CARD_1_TITLE: 'ADVANCE TRADING',
    SECTION_3_CARD_1_TEXT: 'Professional trading of Bitcoin and cryptocurrencies in real-time with fast execution and high liquidity',
    SECTION_3_CARD_2_TITLE: 'PAYMENT OPTIONS',
    SECTION_3_CARD_2_TEXT: 'Most popular methods: payment through bank debit card and direct bank transfer',
    SECTION_3_CARD_3_TITLE: 'STRONG SECURITY',
    SECTION_3_CARD_3_TEXT: 'Protection against DDoS attacks, full data encryption, compliant with PCI DSS standard, multisig wallets and one time password thorugh Google Authenticator',
    SECTION_3_CARD_4_TITLE: 'ADVANCED REPORTING',
    SECTION_3_CARD_4_TEXT: 'Downloadable reports, real-time balance, transaction history with transparent fees',
    SECTION_3_CARD_5_TITLE: 'CUSTOMER SUPPORT',
    SECTION_3_CARD_5_TEXT: 'Fast and reliable customer support with 1 business day response time',
    SECTION_3_CARD_6_TITLE: 'LEGAL COMPLIANCE',
    SECTION_3_CARD_6_TEXT: 'Fully compliant within the local law and regulation by providing full transparency of the service',
  ...
  FOOTER: {
    FOOTER_LEGAL: [
      ...
      'Copyright â’¸ 2017 ExirTech.',
    ],
    FOOTER_LANGUAGE_TEXT: 'LANGUAGE',
    FOOTER_LANGUAGE_LANGUAGES: [
      { key: 'en', label: 'English' },
      { key: 'fa', label: 'ÙØ§Ø±Ø³ÛŒ' },
    ],
    FOOTER_COPYRIGHT: 'All RIGHTS RESERVED',
    SECTIONS: {
      SECTION_1_TITLE: 'SERVICES',
      SECTION_1_LINK_1: 'Buy Bitcoin',
      SECTION_1_LINK_2: 'Sell Bitcoin',
      SECTION_1_LINK_3: 'Bitcoin Wallet',
      SECTION_1_LINK_4: 'Bitcoin Trading',
      SECTION_1_LINK_5: 'Quick Buy and Sell',
