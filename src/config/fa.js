export default {
  ...
  HOME: {
    ...
    SECTION_3_CARD_4_TEXT: 'گزارش های قابل دانلود، موجودی لحظه ای، تاریخ تراکنش با کارمزدهای شفاف',
 ...
 REQUEST_RESET_PASSWORD_SUCCESS: {
   ...
   TEXT: 'اگر حساب کاربری برای آدرس ایمیل وجود داشته باشد، یک ایمیل به آن با دستورالعمل تنظیم مجدد ارسال شده است. لطفا ایمیل خود را بررسی کنید و روی لینک کلیک کنید تا تنظیم مجدد رمز عبور خود را کامل کنید',
 },
 RESET_PASSWORD: {
 ...
 VERIFICATION_TEXTS: {
   ...
   TEXT_1: 'ایمیل خود را بررسی کنید و روی لینک کلیک کنید تا خودتان را تأیید کنید',
   TEXT_2: 'اگر هیچ تأیید ایمیل دریافت نکرده اید و ایمیل های ناخواسته خود را بررسی کرده اید، می توانید روی ارسال مجدد کلیک کنید.',
 },
 ...
 VERIFICATION_EMAIL_REQUEST_SUCCESS: {
   ...
   TEXT_1: 'اگر بعد از چند دقیقه هنوز تأیید ایمیل را دریافت نکرده اید، لطفا با ما در زیر تماس بگیرید',
 },
 VERIFICATION_EMAIL: {
 ...
 USER_VERIFICATION: {
  ...
  USER_DOCUMENTATION_FORM: {
   ...
   ID_DOCUMENTS_FORM: {
     VALIDATIONS: {
       ...
       PROOF_OF_RESIDENCY: 'لطفا اسکن سندی را که اثبات آدرس شما در حال حاضر است، آپلود کنید',
     },
     FORM_FIELDS: {
     ...
     INFORMATION: {
       ...
       POR: {
         ...
         SECTION_1_TEXT_2: 'نام، آدرس، تاریخ صدور و صادر کننده  به وضوح قابل مشاهده است.',
         SECTION_1_TEXT_3: 'مدارک اقامت سند ارائه شده، در  سه ماه گذشته است.',
         SECTION_1_TEXT_4: 'عکس های رنگی یا تصاویر اسکن شده با کیفیت بالا (حداقل 300 DPI)',
         ...
         SECTION_2_LIST_ITEM_3: 'سند صادر شده توسط دولت (بیانیه مالیاتی، گواهی اقامت و غیره)',
         WARNING: 'ما نمی توانیم آدرس در سند هویت ارائه شده را به عنوان یک مدارک معتبر از محل اقامت قبول کنی',
       },
     }
   },
   BANK_ACCOUNT_FORM: {
  ...
  DEPOSIT_VERIFICATION_WAITING_MESSAGE: 'لطفا هنگامی که پرداخت در حال تأیید شدن است، برنامه را نبندید',
  DEPOSIT_VERIFICATION_WARNING_MESSAGE: 'اگر در تأیید مشکلی پیش آمد، لطفا با ما تماس بگیرید.',
  DEPOSIT_VERIFICATION_WARNING_INFORMATION: 'این شناسه عملیات است: "{0}"، لطفا این شناسه را در صورت نیاز به کمک به ما ارائه کنید.',
  ...
  ATEFIELD_TOOGLE_DATE_PE: 'تاریخ شمسی‌',
