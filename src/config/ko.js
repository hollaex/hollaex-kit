export default {
	...
	HOME: {
		...
		SECTION_3_CARD_2_TEXT:
			'맞춤형 모듈과 연결하여 은행과의 통합이 가능합니다. 현지 시장에 맞추어 통합가능한 거래소를 만들수 있습니다.',
		SECTION_3_CARD_3_TITLE: '강력한 보안시스템',
		SECTION_3_CARD_3_TEXT:
			'보안을 최우선순위로 두고 주의를 기울입니다. HollaEx는 자금을 안전하게 유지하기 위해 최상의 보안관행과 가장 안전하고 신뢰할 수 있는 알고리즘을 사용합니다.',
		SECTION_3_CARD_4_TITLE: '고급 리포팅 기능',
		SECTION_3_CARD_4_TEXT:
			'어드민 패널로 시스템 및 트랜잭션 상태에 대해 서포터 및 관리자에게 통지하기 위한 맞춤형의 이메일과 보고서등을 제공합니다.',
	...
	FOOTER: {
		...
		SECTIONS: {
			...
			SECTION_3_LINK_2: '서버 상태'
		}
	},
	ACCOUNTS: {
		TITLE: '계정',
		TAB_VERIFICATION: '본인인증',
		TAB_SECURITY: '보안',
	...
	CONTACT_FORM: {
		...
		DESCRIPTION_LABEL: '문의내용',
		DESCRIPTION_PLACEHOLDER: '문의 상세 내용을 작성하여 주시기바랍니다.',
		ATTACHMENT_LABEL: '첨부파일',
		ATTACHMENT_PLACEHOLDER:
			'더 나은 상담을 위하여 문의내용과 관련된 이미지 파일을 첨부해주시기바랍니다.(PDF, JPG, PNG, GIF 파일첨부가능)',
		SUCCESS_MESSAGE: '고객센터로 이메일이 전송되었습니다.',
		SUCCESS_TITLE: '이메일 전송완료',
		SUCCESS_MESSAGE_1: '문의내용이 고객 센터로 전송되었습니다.',
		SUCCESS_MESSAGE_2: '문의사항에 대한 답변은 약 1-3 영업일이 소요됩니다.'
	},
	DEPOSIT: {
		CRYPTO_LABELS: {
			BTC: '비트코인 입금 주소',
	...
	NOTIFICATIONS: {
		...
		DEPOSITS: {
			...
			BTC: {
				TITLE_RECEIVED: '{0} BTC 입금완료',
				TITLE_INCOMING: '{0} BTC 입금진행안내',
				SUBTITLE_RECEIVED: '회원님의 {0}BTC 입금이 완료되었습니다.',
				SUBTITLE_INCOMING: '회원님의 {0}BTC 입금이 진행중입니다.',
				INFORMATION_PENDING_1:
					'비트코인 거래를 위해서는 블록체인상의 최소 1개의 승인이 필요합니다.',
				INFORMATION_PENDING_2:
					'입금완료까지 평균 10~30분 정도 소요되며, 상황에 따라 지연될 수 있습니다. 입금 신청 이후 블록체인 상의 승인이 완료되면 입금완료 이메일을 보내드립니다.'
			},
			ETH: {
				TITLE_RECEIVED: '{0} ETH 입금완료',
				TITLE_INCOMING: '{0} ETH 입금진행안내',
				SUBTITLE_RECEIVED: '회원님의 {0} ETH 입금이 완료되었습니다.',
				SUBTITLE_INCOMING: '회원님의 {0} ETH 입금이 진행중입니다.',
				INFORMATION_PENDING_1:
					'이더리움 거래를 위해서는 블록체인상의 최소 15개의 승인이 필요합니다.',
				INFORMATION_PENDING_2:
					'입금완료까지 평균 10~30분 정도 소요되며, 상황에 따라 지연될 수 있습니다. 입금 신청 이후 블록체인 상의 승인이 완료되면 입금완료 이메일을 보내드립니다.'
			},
			BCH: {
				TITLE_RECEIVED: '{0} BCH 입금완료',
				TITLE_INCOMING: '{0} BCH 입금진행안내',
				SUBTITLE_RECEIVED: '회원님의 {0}BCH 입금이 완료되었습니다.',
				SUBTITLE_INCOMING: '회원님의 {0}BCH 입금이 진행중입니다.',
				INFORMATION_PENDING_1:
	...
	REQUEST_RESET_PASSWORD_SUCCESS: {
		...
		TEXT:
			'회원님의 계정에 등록된 이메일로 전송된 링크를 따라 비밀번호 재설정을 완료하시기 바랍니다.'
	},
	RESET_PASSWORD: {
		TITLE: '새 비밀번호 설정',
		SUBTITLE: '새 비밀번호 설정',
	...
	VERIFICATION_TEXTS: {
		TITLE: '계정 활성화를 위한 인증메일이 전송되었습니다.',
		TEXT_1: '전송된 이메일의 링크를 따라 인증을 진행하시기 바랍니다.',
		TEXT_2:
			'인증 이메일을 받지 못했을 경우 스팸 메일함을 확인해주시기 바랍니다. 또한, 아래의 요청을 통해 이메일을 재전송하실 수 있습니다.'
	},
	VERIFICATION_EMAIL_REQUEST: {
		TITLE: '계정 활성화 이메일 보내기',
		BUTTON: '이메일 전송하기'
	},
	...
	USER_VERIFICATION: {
		...
		INFO_TXT_2: '*은행과 신원 부문은 완전한 검증을 위해 {0}가 요구됩니다.', 
		...
		GOTO_VERIFICATION: '인증화면으로 가기 Go to verification',
		CONNECT_BANK_ACCOUNT: '은행계좌 연결하기', 
		ACTIVATE_2FA: 'Activate 2FA', 
		INCOMPLETED: 'Incompleted', 
		BANK_VERIFICATION: '은행 인증 Bank Verification', 
		IDENTITY_VERIFICATION: '신분 인증 Identity Verification', 
		PHONE_VERIFICATION: '연락처 인증 Phone Verification', 
		DOCUMENT_VERIFICATION: '문서 인증 Document Verification', 
		START_BANK_VERIFICATION: '은행 인증하기 Start Bank Verification', 
		START_IDENTITY_VERIFICATION: '신원 인증하기 Start Identity Verification', 
		START_PHONE_VERIFICATION: '연락처 인증하기 Start Phone Verification', 
		START_DOCUMENTATION_SUBMISSION: '문서업로드 시작하기  Start Documentation Submission', 
		GO_BACK: '되돌아가기', 
		...
		ACCOUNT_NUMBER: '계좌번호', 
		CARD_NUMBER: '카드번호', 
		BANK_VERIFICATION_HELP_TEXT: '{0} 부문을 완료한 이후에만, 이 부문의 인증을 진행 하실 수 있습니다.', 
		DOCUMENT_SUBMISSION: '문서제출', 
	...
	WITHDRAWALS_MIN_VALUE_ERROR:
		'출금금액이 너무 작아 보낼 수 없습니다.   The transaction i s too small to send. Try a larger amount.',
	...
	AVAILABLE_TEXT: '사용가능',
	AVAILABLE_BALANCE_TEXT: '사용가능 {0} 잔액: {1} {2}', // Available Bitcoin Balance: 2.6 BTC
	BALANCE_TEXT: '잔액',
	CURRENCY_BALANCE_TEXT: '{0} 잔액',
	WALLET_TABLE_AMOUNT_IN: `Amount in {0}`,
	WALLET_TABLE_TOTAL: '총찹',
	WALLET_ALL_ASSETS: '총 자산',
	HIDE_TEXT: '숨기기',
	...
	SUMMARY: { 
		...
		URGENT_REQUIREMENTS: '긴급 요구 Urgent Requirements',
		TRADING_VOLUME: '총 거래량e',
		ACCOUNT_ASSETS: '총 자산  Assets',
		ACCOUNT_DETAILS: '상세정보 Account Details',
		...
		ACCOUNT_ASSETS_TXT_1: '총 자산을 한눈에 확인할 수 있습니다.. Displayed is a summery of all your assets.',
		ACCOUNT_ASSETS_TXT_2: '많은 양의 자산을 보유하고 있는 것은 낮은 거래수수료와 특별한 뱃지를 포함한 계정 업그레이드가 가능한 자격이 주어집니다.',
		...
		FEES_AND_LIMIT: '수수료 및 한도 구조 ??  Fee and Limit Structure for',
