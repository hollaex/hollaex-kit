export default {
  ...
  HOME: {
    ...
    SECTION_1_TEXT_1: 'EXIR is a cryptocurrency exchange where you can buy and sell bitcoins and other digital currencies in Iran.',
    SECTION_1_TEXT_2: 'We strive to bring the financial technology forward through afforable and simple access to Bitcoin and cryptocurrencies.',
    SECTION_1_BUTTON_1: 'Learn more',
    SECTION_3_TITLE: 'Features',
    SECTION_3_CARD_1_TITLE: 'PROFESSIONAL TRADING',
    SECTION_3_CARD_1_TEXT: 'Professional Bitcoin trading in real-time with advance tools',
    SECTION_3_CARD_2_TITLE: 'PAYMENT OPTIONS',
    SECTION_3_CARD_2_TEXT: 'Payment throguh conventional methods like cards or bank transfer',
    ...
    SECTION_3_CARD_5_TEXT: 'Fast and reliable support with quick resposne during working hours',
    SECTION_3_CARD_6_TITLE: 'LEGAL COMPLIANCE',
    SECTION_3_CARD_6_TEXT: 'Legal compliant in Iran with full trasparency and strong relationship with banks',
 ...
 NOTIFICATIONS: {
   ...
   DEPOSITS: {
     ...
     BTC: {
       ...
       INFORMATION_PENDING_1: 'Your {0} require 1 confirmations before you can begin trading.',
       INFORMATION_PENDING_2: 'This may take 10-30 minutes. We will send an email once your {0} have completed Confirming.',
     }
   },
 },
 OTP_FORM: {
 ...
 USER_VERIFICATION: {
   ...
   USER_DOCUMENTATION_FORM: {
     FORM_FIELDS: {
       ...
       FIRST_NAME_PLACEHOLDER: 'Type your first name as it appears on your identity document',
       LAST_NAME_LABEL: 'Last name',
       LAST_NAME_PLACEHOLDER: 'Type your last name as it appears on your identity document',
       FULL_NAME_LABEL: 'Your Full Name',
       FULL_NAME_PLACEHOLDER: 'Type your full name as it appears on your identity document',
       GENDER_LABEL: 'Gender',
       ...
       NATIONALITY_PLACEHOLDER: 'Type what nationality is on your identity document',
   ...
   ID_DOCUMENTS_FORM: {
     VALIDATIONS: {
       ...
       EXPIRATION_DATE: 'Please select the date when your document will expire',
       FRONT: 'Please upload a scan of your photo identity document',
       PROOF_OF_RESIDENCY: 'Please upload a scan of document proving the address you current reside',
     },
     FORM_FIELDS: {
     ...
     INFORMATION: {
       ...
       ID_SECTION: {
         ...
         WARNING_1: 'Only a valid government-issued identification document is accepted.',
         WARNING_2: 'Make sure you are uploading your own documents. Any usage of wrong or fake documents will have legal consequences and result in freezing your account immidiately.',
       },
       POR: {
         SECTION_1_TEXT_1: 'To avoid delays when verifying your account, please make sure:',
         SECTION_1_TEXT_2: 'Your NAME, ADDRESS, ISSUE DATE and ISSUER are clearly visible.',
         SECTION_1_TEXT_3: 'The submitted proof of residence document is NOT OLDER THAN THREE MONTHS.',
         SECTION_1_TEXT_4: 'You submit color photographs or scanned images in HIGH QUALITY (at least 300 DPI)',
         SECTION_2_TITLE: 'AN ACCEPTABLE PROOF OF RESIDENCE IS:',
         SECTION_2_LIST_ITEM_1: 'A bank account statement.',
         SECTION_2_LIST_ITEM_2: 'A utility bill (electricity, water, internet, etc.).',
         SECTION_2_LIST_ITEM_3: 'A government-issued document (tax statement, certificate of residency, etc.).',
         WARNING: 'We cannot accept the address on your submitted identity document as a valid proof of residence.',
       },
     }
   },
   BANK_ACCOUNT_FORM: {
     ...
     FORM_FIELDS: {
       ...
       CARD_NUMBER_PLACEHOLDER: 'Type the 16 digit number that is on the front of your bank card',
     },
   },
   WARNING: {
  ...
  DEPOSIT_BANK_REFERENCE: 'Add this "{0}" code to the bank transation to identify the deposit',
  ...
  QUICK_TRADE_ORDER_CAN_NOT_BE_FILLED: 'The order with the current size can not be filled',
  ...
  VERIFICATION_NOTIFICATION_SKIP_TEXT: 'To get full access to withdrawal and deposit functions on EXIR you must submit your identity documents in your account page.',
  VERIFICATION_NOTIFICATION_SUCCESS_TITLE: 'Success!',
  VERIFICATION_NOTIFICATION_SUCCESS_TEXT: 'You will receive an email notification when your information has been processed. Processing can typically take 1-3 days.',
