 ...
 USER_VERIFICATION: {
   ...
   BANK_ACCOUNT_FORM: {
     ...
     FORM_FIELDS: {
       ...
       CARD_NUMBER_PLACEHOLDER: 'Type the number that is on the front of your bank card',
     },
   },
   WARNING: {
  ...
  VERIFICATION_NOTIFICATION_SUCCESS_TEXT: 'You will receive an email notification and SMS when your information has been processed. Processing can typically take 1-3 days.',
