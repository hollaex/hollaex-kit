   ...
   ID_DOCUMENTS_FORM: {
     ...
     INFORMATION: {
       ...
       ID_SECTION: {
         ...
         WARNING_1: 'Please do not submit the identity document as your proof of residence.',
         WARNING_2: 'Only a valid government-issued identification document; high quality photos or scanned images of these documents are acceptable.',
       },
       POR: {
