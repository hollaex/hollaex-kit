    ...
    return (
      <div className="verification-wrapper d-flex justify-content-center align-items-center f-1">
        <div className="verification-content-wrapper">
          ...
          {ready && data.ready &&
            <div className="verification-message-wrapper">{STRINGS.DEPOSIT_VERIFICATION_SUCCESS}</div>
          }
          {error &&
            <div className="verification-message-wrapper text-center">
              ...
              {deposit_id &&
                <div className="block-wrapper">
                  ...
                  <div>{STRINGS.formatString(STRINGS.DEPOSIT_VERIFICATION_WARNING_INFORMATION, deposit_id)}</div>
                </div>
              }
            </div>}
        </div>
