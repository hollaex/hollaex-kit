...
import { calculatePrice, fiatFormatToCurrency, fiatSymbol } from '../../utils/currency';
    ...
    <table className="wallet-assets_block-table">
      <thead>
        <tr className="table-bottom-border">
          ...
          <th className="align-opposite">{STRINGS.formatString(STRINGS.WALLET_TABLE_AMOUNT_IN, STRINGS.FIAT_NAME)}</th>
        </tr>
      </thead>
      <tbody>
