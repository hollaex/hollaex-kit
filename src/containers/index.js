...
export { default as TradeHistory } from './Admin/TradeHistory';
export { default as UserBalance } from './Admin/UserBalance';
export { default as Logins } from './Admin/Logins';
...
export { default as Balance } from './Admin/Balance';
export { default as AdminVerification } from './Admin/Verification';
export { default as UploadIds } from './Admin/UploadIds';
export { default as Otp } from './Admin/Otp';
export { default as Activate } from './Admin/Activate';
export { ListUsers, FullListUsers } from './Admin/ListUsers';
export { default as Deposits } from './Admin/Deposits';
...
export { default as Trades } from './Admin/Trades';
