...
const createTrade = async (order, opts = { additionalHeaders: null }) => {
	...
	if (maker_fee > 20 || taker_fee > 20) {
		throw new Error(FEES_PERCENTAGE_EXCEED);
	}
	return getNodeLib().createBrokerTrade(
		symbol,
		side,
