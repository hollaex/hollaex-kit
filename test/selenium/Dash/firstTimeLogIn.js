...
async function firstTimeLogIn(){
	...
	// 	it('Creating Exchange', async function() {
	...
	// 		console.log(step++,'//*[@id="dash-main"]/div/div/div/div');
	// 		assert(await driver.findElement(By.xpath('//*[@id="dash-main"]/div/div/div/div')).getText() == "First-Time Exchange Operator")
			
	// 		console.log(step++,' | click | css=.ant-btn | ');
	// 		 await driver.findElement(By.css(".ant-btn")).click()
	// 		 await sleep(5000);

	// 		 console.log(step++,' | click | id=general form_EXCHANGE_NAME | ');
	// 		 await driver.findElement(By.id("general form_EXCHANGE_NAME")).click()
	// 		 await sleep(5000);

	// 		 console.log(step++,' | type | id=general form_EXCHANGE_NAME | ',newUser);
	// 		 await driver.findElement(By.id("general form_EXCHANGE_NAME")).sendKeys(newUser)
	// 		 await sleep(5000);
	...
	// 		 console.log(step++,' | click | css=.sidebar-menu-dash > div > div:nth-child(1) | ');
	// 		 await driver.findElement(By.css(".sidebar-menu-dash > div > div:nth-child(1)")).click()
	// 		 await sleep(5000);
	...
	// 	});
		it('Email Confirmation', async function() {
			...
			expect(trickedEmailCont.includes("Congratulations! You have completed the first step to start your exchange ")).to.equal(true);
