...
async function logIn(){
    ...
    // 5 | click | linkText=Security | 
    await driver.findElement(By.linkText("Security")).click()
    // 6 | click | css=.ant-collapse-item:nth-child(1) > .ant-collapse-header | 
    await driver.findElement(By.css(".ant-collapse-item:nth-child(1) > .ant-collapse-header")).click()
    // 7 | type | id=reset form_curPw | Ggzz7DN7HHXimPM
    await driver.findElement(By.id("reset form_curPw")).sendKeys("Ggzz7DN7HHXimPM")
    // 8 | click | id=reset form_curPw | 
    await driver.findElement(By.id("reset form_curPw")).click()
    // 9 | click | id=reset form_newPw | 
    await driver.findElement(By.id("reset form_newPw")).click()
    // 10 | type | id=reset form_newPw | n
    await driver.findElement(By.id("reset form_newPw")).sendKeys("n")
    // 11 | click | id=reset form_chkPw | 
    await driver.findElement(By.id("reset form_chkPw")).click()
    // 12 | click | id=reset form_chkPw | 
    await driver.findElement(By.id("reset form_chkPw")).click()
    // 13 | type | id=reset form_chkPw | n
    await driver.findElement(By.id("reset form_chkPw")).sendKeys("n")
    // 14 | click | css=.ant-btn:nth-child(1) | 
