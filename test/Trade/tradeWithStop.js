...
describe('Trade with stop', function() {
  ...
  it('Limit Buy', async function() {
    ...
    // await driver.findElement(By.name("price")).sendKeys("0.9")
    // await sleep(1000)
    // 5 | click | name=size | 
    ...
    // await driver.wait(until.elementIsEnabled(By.xpath('//*[@id="root"]/div[1]/div[2]/div/div/div[3]/div/div/div/div[3]/div[1]/div[2]/div/div/form/button'), 5000));
    // await driver.findElement(By.xpath('//*[@id="root"]/div[1]/div[2]/div/div/div[3]/div/div/div/div[3]/div[1]/div[2]/div/div/form/button')).click()
  ...
  it('Limit sell', async function(){
    ...
    // await driver.findElement(By.name("stop")).sendKeys(String(value - 0.1 ))
